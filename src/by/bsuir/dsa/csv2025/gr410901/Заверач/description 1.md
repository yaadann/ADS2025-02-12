...
Простыми числами-близнецами называются пары простых чисел, которые отличаются друг от друга ровно на 2.  

Исследование простых-близнецов важно не только в математике, но и в прикладных областях:
они используются в криптографии, исследовании распределения простых чисел, анализе больших числовых последовательностей и оптимизации алгоритмов, которые опираются на структуру простых чисел.
Теперь, когда большие простые числа стали ключевым элементом безопасности в интернете, понимание их свойств — в том числе свойств «почти соседних» простых чисел — помогает создавать более устойчивые криптографические протоколы и исследовать предельное поведение алгоритмов генерации простых чисел.
...
В данной задаче вам необходимо с использованием **решета Эратосфена** найти все пары простых чисел-близнецов на отрезке от 1 до n.
...
Вывести все пары простых-близнецов в порядке возрастания в одной строке, разделенные пробелами, в формате:

p1 p2 p3 p4 ...

Если таких пар нет — вывести ничего.
