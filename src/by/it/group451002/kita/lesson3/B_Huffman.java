...
public class B_Huffman {
    ...
    String decode(InputStream inputStream) throws FileNotFoundException {
        ...
        //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! НАЧАЛО ЗАДАЧИ !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
        scanner.nextLine();
        // создание хеш-таблицы для символов и их кодов
        HashMap<Integer, Character> map = new HashMap<>();
        for (int i = 1; i <= count; i++){
            String currStr = scanner.nextLine();//текущая строка для ключа и символа
            String[] parts = currStr.split(": ");
            char character = parts[0].charAt(0); //символ
            int code = Integer.valueOf(parts[1]); //его код
            map.put(code, character); //заносим в хеш-таблицу
        }
        ...
        for (char c : encodeStr.toCharArray()){
            currentCode += c;
            // Если в хеш-таблице есть символ с таким кодом, заносим в строку
