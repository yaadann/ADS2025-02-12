...
public class A_QSort {
    ...
    int[] getAccessory(InputStream stream) throws FileNotFoundException {
        ...
        for (int i = 0; i < m; i++) {
            ...
            // Все отрезки до firstAfter могут содержать точку, если их stop >= point
            // Оптимизированный подсчет с использованием бинарного поиска
            left = 0;
            right = firstAfter;
            while (left < right) {
                int mid = (left + right) / 2;
    ...
    private class Segment implements Comparable<Segment> {
        ...
        public int compareTo(Segment o) {
            // Сортируем по start, а при равенстве - по stop
