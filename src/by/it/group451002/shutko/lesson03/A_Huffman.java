...
////Считывает частоту появления каждого символа и сохраняет это в Map<Character, Integer> count.
////Создает приоритетную очередь (PriorityQueue<Node>), где каждый узел представляет символ и его частоту.
////Построение дерева Хаффмана:
////Из очереди извлекаются два узла с наименьшей частотой.
////Создается новый внутренний узел, который соединяет эти два узла, и добавляется обратно в очередь.
////Процесс продолжается до тех пор, пока в очереди не останется только один узел — корень дерева.
