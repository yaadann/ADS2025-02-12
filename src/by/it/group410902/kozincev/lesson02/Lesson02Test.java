...
public class Lesson02Test {
    ...
    */
    ...
    public void checkC_greedyKnapsack() throws Exception {
        ...
        InputStream inputStream2 = C_GreedyKnapsack.class.getResourceAsStream("greedyKnapsack2.txt");
        //Добавлен второй testCase и соответственно второй txt-шник

        double costFinal = new C_GreedyKnapsack().calc(inputStream);
        double costFinal2 = new C_GreedyKnapsack().calc(inputStream2);
        boolean ok = costFinal == 200 && costFinal2 == 152.5;
