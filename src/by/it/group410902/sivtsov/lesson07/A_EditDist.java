...
public class A_EditDist {
    ...
    int getDistanceEdinting(String one, String two) {
        //!!!!!!!!!!!!!!!!!!!!!!!!!     НАЧАЛО ЗАДАЧИ     !!!!!!!!!!!!!!!!!!!!!!!!!
        int result = levDist(one, two, one.length(), two.length());
    ...
    private int levDist(String s1, String s2, int len1, int len2) {
        ...
        if (s1.charAt(len1 - 1) == s2.charAt(len2 - 1)) {
            return levDist(s1, s2, len1 - 1, len2 - 1);
        }
        ...
        int deletion = levDist(s1, s2, len1 - 1, len2);
        int insertion = levDist(s1, s2, len1, len2 - 1);
        int substitution = levDist(s1, s2, len1 - 1, len2 - 1);
