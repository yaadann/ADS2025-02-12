package by.it.group410902.gavlev.lesson03;
...
public class B_Huffman {
    ...
    String decode(InputStream inputStream) throws FileNotFoundException {
        ...
        for (int i = 0; i < count; i++) {
            ...
            char symbol = parts[0].charAt(0);    // Получаем символ
            String code = parts[1];              // Получаем код
            codeMap.put(code, symbol);           // Добавляем в словарь
        }
