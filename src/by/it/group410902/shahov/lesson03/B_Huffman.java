package by.it.group410902.shahov.lesson03;
...
public class B_Huffman {
    ...
    String decode(InputStream inputStream) throws FileNotFoundException {
        ...
        java.util.HashMap<String, Character> codeMap = new java.util.HashMap<>();

        // Читаем коды символов
        scanner.nextLine(); // Пропускаем оставшуюся часть первой строки
        for (int i = 0; i < count; i++) {
            String line = scanner.nextLine();
            int separatorPos = line.indexOf(": ");
            char character = line.charAt(0);
            String code = line.substring(separatorPos + 2);
