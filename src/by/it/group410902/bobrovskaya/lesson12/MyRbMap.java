...
public class MyRbMap implements SortedMap<Integer, String> {
    ...
    public String toString() {
        ...
        inorderTraversal(root, resultStr); // обход дерева в порядке возрастания ключей
    ...
    private void inorderTraversal(Node node, StringBuilder sb) {
        if (node != null) {
            inorderTraversal(node.left, sb); // рекурс обход левого поддерева
            sb.append(node.key).append("=").append(node.info).append(", ");
            inorderTraversal(node.right, sb); // рекурс обход правого поддерева
        }
    }
    ...
    public String put(Integer key, String value) {
        ...
        String oldInfo = get(key); // проверка, есть ли элемент с таким ключом
        root = put(root, key, value); // находит места и вставляет/обновляет значение
        root.color = BLACK;
        return oldInfo;
    }
    ...
    public String get(Object obj) {
        ...
        Node node = root; // начало поиска - корень
        while (node != null) {
    ...
    public boolean containsKey(Object obj) {
        ...
        Integer k = (Integer) obj;
        return get(k) != null; // сверяем, есть ли ключ
    }
    ...
    private boolean containsValue(Node node, String info) {
        ...
        // продолжаем поиск в левом и правом поддеревьях
    ...
    // вставка узла, сбалансирование дерева и возвращение ссылки на root
