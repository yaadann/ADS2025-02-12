...
public class Test_Part2_Lesson13 extends HomeWork {
    ...
    public void testGraphC() {
        ...
        run("A->B, B->C, C->D, D->E, E->F", true).include("A\nB\nC\nD\nE\nF");
        run("1->2, 2->3, 3->1, 2->4, 4->5, 5->6, 6->4, 3->7, 7->8, 8->9, 9->7", true).include("123\n456\n789");
        run("A->A", true).include("A");
        run("1->2, 2->3, 3->4, 4->5, 5->1, 2->6, 6->7, 7->8, 8->6, 4->9", true).include("12345\n678\n9");
