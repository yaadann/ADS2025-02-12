package by.it.group410902.plekhova.lesson09;
...
public class ListC<E> implements List<E> {
    ...
    public E remove(int index) {
        ...
        E removedElement = (E) elements[index]; // удаляемый элемент сохраняется для возвращения из метода
    ...
    public E get(int index) {
        if (index < 0 || index >= size) {  // Исправлено: добавлено
            throw new IndexOutOfBoundsException("Index: " + index + ", Size: " + size);
        }
    ...
    // удалить все элементы, которых нет в с
    @Override
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        if (fromIndex < 0 || toIndex > size || fromIndex > toIndex) {  // Исправлено условие
