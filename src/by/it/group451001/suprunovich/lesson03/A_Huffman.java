package by.it.group451001.suprunovich.lesson03;
...
public class A_Huffman {
    ...
    private class InternalNode extends by.it.group451001.suprunovich.lesson03.A_Huffman.Node {
        //внутренный узел дерева
        by.it.group451001.suprunovich.lesson03.A_Huffman.Node left;  //левый ребенок бинарного дерева
        by.it.group451001.suprunovich.lesson03.A_Huffman.Node right; //правый ребенок бинарного дерева

        //для этого дерева не существует внутренних узлов без обоих детей
        //поэтому вот такого конструктора будет достаточно
        InternalNode(by.it.group451001.suprunovich.lesson03.A_Huffman.Node left, by.it.group451001.suprunovich.lesson03.A_Huffman.Node right) {
