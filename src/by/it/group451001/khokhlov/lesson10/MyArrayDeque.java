...
public class MyArrayDeque<E> implements Deque<E> {
    ...
    // Методы, которые нужно реализовать по контракту интерфейса,
    // но которые не являются обязательными по заданию
    // (возвращают false или бросают исключения)
    ...
    // Они возвращают значения по умолчанию или бросают исключения
