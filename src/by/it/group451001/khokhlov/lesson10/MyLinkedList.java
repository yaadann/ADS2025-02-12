...
public class MyLinkedList<E> implements Deque<E> {
    ...
    // Удаление по индексу - отдельный метод
    ...
    // Переопределяем remove(Object o) из интерфейса Deque
    @Override
    ...
    // Реализация остальных обязательных методов Deque
