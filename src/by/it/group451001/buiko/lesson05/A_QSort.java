...
public class A_QSort {
    ...
    // Метод для поиска верхней границы (количество элементов <= key)
    ...
    // Метод для поиска нижней границы (количество элементов < key)
    ...
    private class Segment implements Comparable<Segment> {
        ...
        Segment(int start, int stop) {
            this.start = Math.min(start, stop); // Убедимся, что start <= end
...
// считаем сколько регистраторов начало снимать до начало события
// и сколько завершили снимать до события
// считаем разницу между этими значениями