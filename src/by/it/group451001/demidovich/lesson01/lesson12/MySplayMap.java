package by.it.group451001.demidovich.lesson01.lesson12;
...
public class MySplayMap implements NavigableMap<Integer, String> {
    ...
    // поднимает узел с ключом key в корень.
    // Если ключа нет, поднимает последний посещённый узел
    ...
    // get: splay по ключу и возвращает значение, если корень совпадает
    ...
    // splay по ключу; если ключ найден — обновляем значение.
    // Если нет — создаём новый узел и делаем его корнем, сохраняя старое дерево как поддеревья.
    ...
    // splay по ключу; если корень содержит ключ — удаляем.
    ...
    // обход (лево-корень-право) — обеспечивает вывод в порядке возрастания ключей,
    // формат как у стандартной Map: {k1=v1, k2=v2}
    ...
    // собирает в новый MySplayMap все элементы с ключами < toKey
    ...
    // собирает в m все узлы с ключами меньше toKey
    ...
    // собирает в новый MySplayMap все элементы с ключами >= fromKey
    ...
    // собирает в m все узлы с ключами больше или равны fromKey
    ...
    // firstKey / lastKey: минимальный / максимальный ключ в дереве
