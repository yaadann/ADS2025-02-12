...
public class SourceScannerA {
    ...
    public static void main(String[] args) {
        ...
        List<by.it.group451001.zhynko.lesson15.SourceScannerA.FileData> fileDataList = new ArrayList<>();
        ...
        for (by.it.group451001.zhynko.lesson15.SourceScannerA.FileData data : fileDataList) {
            System.out.println(data.size + " " + data.relativePath);
        }
    }

    private static void processJavaFile(Path file, List<by.it.group451001.zhynko.lesson15.SourceScannerA.FileData> fileDataList) {
        try {
            ...
            fileDataList.add(new by.it.group451001.zhynko.lesson15.SourceScannerA.FileData(size, relativePath));
