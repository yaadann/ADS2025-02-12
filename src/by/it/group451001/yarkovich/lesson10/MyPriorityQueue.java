...
public class MyPriorityQueue<E> implements Queue<E> {
    ...
    // Если null, используется натуральный порядок (элементы должны реализовывать Comparable)
     ...
     * ВАЖНО: Элементы выводятся в порядке массива кучи, а не в отсортированном порядке!
    ...
    public boolean add(E element) {
        ...
        // В PriorityQueue add всегда возвращает true (в отличие от некоторых других коллекций)
     ...
     * Время выполнения: O(n) - более эффективно чем n раз вызвать offer (O(n log n))
     *
    ...
    private void heapify() {
        ...
        // Такой порядок гарантирует что при просеивании узла его потомки уже являются корректными кучами
