...
public class MyLinkedList<E> implements Deque<E> {
    ...
    // Каждый узел содержит: данные, ссылку на предыдущий узел и ссылку на следующий узел
    ...
    private E unlink(Node<E> node) {
        ...
        // Обновляем ссылки: если есть предыдущий узел, его next теперь указывает на следующий узел
        if (prevNode != null) {
        ...
        // Обновляем ссылки: если есть следующий узел, его prev теперь указывает на предыдущий узел
        if (nextNode != null) {
