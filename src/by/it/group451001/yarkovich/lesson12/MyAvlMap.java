 ...
 * где для каждой вершины высота ее двух поддеревьев различается не более чем на 1.
...
public class MyAvlMap implements Map<Integer, String> {
    ...
    /**
     * Центрированный обход дерева (in-order traversal) для построения строкового представления.
    ...
    /**
     * Удаляет пару ключ-значение только если ключ сопоставлен с указанным значением.
     * Не реализовано в данной версии.
     */
    @Override
    ...
    /**
     * Заменяет значение для ключа только если ключ сопоставлен с указанным значением.
     * Не реализовано в данной версии.
     */
    @Override
