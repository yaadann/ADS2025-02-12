package by.it.group451001.volynets.lesson07;
...
public class C_EditDist {
    ...
    String getDistanceEdinting(String one, String two) {
        ...
        // Заполнение базовых случаев: преобразование пустой строки
        ...
        // Восстановление пути (редакционного предписания) по матрице dp
        StringBuilder sb = new StringBuilder();
        int i = n, j = m;
        while (i > 0 || j > 0) {
            // Копирование (совпадение символов)
