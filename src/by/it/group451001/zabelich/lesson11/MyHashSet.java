package by.it.group451001.zabelich.lesson11;

import java.util.Collection;
import java.util.Iterator;

/**
 * Реализация множества на основе хеш-таблицы с методом цепочек для разрешения
 * коллизий.
 * Элементы хранятся в бакетах, каждый бакет представляет собой односвязный
 * список.
 */
