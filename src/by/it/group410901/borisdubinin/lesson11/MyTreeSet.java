...
public class MyTreeSet<E> implements Set<E> {
    ...
    private int findIndex(Object o) {
        ...
        while (lo <= hi) {
            ...
            int cmp = compare(array[mid], o);  // Сравнение среднего элемента с искомым
    ...
    public String toString() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            sb.append(array[i]);             // Добавляем строковое представление элемента
        }
    ...
    public boolean remove(Object o) {
        ...
        if (tail > 0) {
            System.arraycopy(array, idx + 1, array, idx, tail);
        }
    ...
    public boolean retainAll(Collection<?> c) {
        Object[] na = new Object[array.length];  // Новый массив для результатов
