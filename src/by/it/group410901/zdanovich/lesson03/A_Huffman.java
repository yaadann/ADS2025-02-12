package by.it.group410901.zdanovich.lesson03;
...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        if (priorityQueue.size() == 1) {
            // Если только один символ — назначим код "0"
            LeafNode onlyNode = (LeafNode) priorityQueue.poll();
            codes.put(onlyNode.symbol, "0");
        } else {
