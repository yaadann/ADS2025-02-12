...
//реализация карты (словаря) на основе самобалансирующегося дерева
...
public class MyAvlMap implements Map<Integer, String> {
    ...
    private void inOrderToString(Node node, StringBuilder sb) { //обходит дерево (левый потомок текущий правый),
                                                                // ключи выводятся в порядке возрастания
        if (node != null) {
    ...
    public String put(Integer key, String value) {
        ...
        String[] oldValue = new String[1];      //массив с одним элементом для возврата значения из рекурсии
