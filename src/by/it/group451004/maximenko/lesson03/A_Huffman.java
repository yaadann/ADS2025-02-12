package by.it.group451004.maximenko.lesson03;
...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        if (root != null) {
            // Если строка состоит из одного символа, нужно обязательно обработать это
            if (count.size() == 1) {
                // Спец случай: только 1 символ => кодировать его 0
                root.fillCodes("0");
            } else {
                root.fillCodes("");
            }
