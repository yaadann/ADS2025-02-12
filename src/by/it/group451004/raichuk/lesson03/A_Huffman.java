package by.it.group451004.raichuk.lesson03;
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        private void generateCodes(Node node, String code, Map<Character, String> huffmanCodes) {
            if (node instanceof LeafNode leaf) {
                huffmanCodes.put(leaf.symbol, code);
            } else if (node instanceof InternalNode internal) {
                generateCodes(internal.left, code + "0", huffmanCodes);
                generateCodes(internal.right, code + "1", huffmanCodes);
            }
        }
