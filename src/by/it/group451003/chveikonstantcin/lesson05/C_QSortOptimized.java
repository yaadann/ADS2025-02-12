package by.it.group451003.chveikonstantcin.lesson05;
...
public class C_QSortOptimized {
    ...
    // Бинарный поиск количества покрывающих отрезков
    private int countCoveringSegments(Segment[] segments, int point) {
        ...
        // Подсчитываем все подходящие отрезки начиная с найденного
        int count = 0;
        for (int i = firstCovering; i >= 0; i--) {
