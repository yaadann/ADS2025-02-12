package by.it.group451003.kharkevich.lesson01.lesson05.lesson05;
...
public class Lesson05Test {
    ...
    public void checkA() throws Exception {
        ...
        InputStream inputStream = new FileInputStream(root + "by/it/a_khmelev/lesson05/dataA.txt");
    ...
    public void checkB() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream inputStream = new FileInputStream(root + "by/it/a_khmelev/lesson05/dataB.txt");
    ...
    public void checkC() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream inputStream = new FileInputStream(root + "by/it/a_khmelev/lesson05/dataC.txt");
