...
public class SourceScannerB {
    ...
    public static void main(String[] args) {
        ...
        List<by.it.group451003.bernat.lesson15.SourceScannerB.FileData> fileDataList = new ArrayList<>();
        ...
        for (by.it.group451003.bernat.lesson15.SourceScannerB.FileData data : fileDataList) {
            System.out.println(data.size + " " + data.relativePath);
        }
    }

    private static void processJavaFile(Path file, Path srcPath, List<by.it.group451003.bernat.lesson15.SourceScannerB.FileData> fileDataList) {
        try {
            ...
            fileDataList.add(new by.it.group451003.bernat.lesson15.SourceScannerB.FileData(size, relativePath));
